...
@section('content')
    <form action="" method="POST">
        <div class="card-body">
            ...
            <div class="form-group">
                ...
                <div class="custom-control custom-radio">
                    <input type="radio" value="1" checked class="custom-control-input" id="active" name="active">
        ...
        <div class="card-footer">
            <button type="submit" class="btn btn-primary float-right">Tạo danh mục</button>
        </div>
        @csrf
    </form>
@endsection
